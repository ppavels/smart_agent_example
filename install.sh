...
MYSQL_DB_NAME="smart_agent_project"

# Get the base url for automatic login.
BASE_DOMAIN_URL="http://localhost/saexample/web"
...
composer create-project drupal-composer/drupal-project:8.x-dev smart_agent_project --stability dev --no-interaction
